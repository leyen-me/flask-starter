...
class Register:
    ...
    # 开启关系型数据库
    @classmethod
    def register_db(cls, app):
        db.init_app(app)

    # 关系型数据库数据初始化
    # 创建表，和初始化数据
    @classmethod
    def register_db_data_init(cls, app):
        with app.app_context():
            Initialize.init()

    # 开启跨域访问
    @classmethod
    def register_cors(cls, app):
    ...
    # 注册路由
    @classmethod
    def register_controller(cls, app):
    ...
    # 注册静态文件路由
    @classmethod
    def register_static_controller(cls, app):
